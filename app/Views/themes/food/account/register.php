    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form role = "form" class = "form-horizontal" id = "defaultForm" method = "post" action = "<?= TinyMvc::toRoute(AppService::Register) ?>">
                    ...
                    <div class = "box-body">
                        <div class = "form-group">
                            ...
                            <div class = "col-md-4">
                                <input type = "text" class = "form-control" id = "sponsorId" name = "sponsor_id" placeholder = "Enter Sponsor Id">
                            </div>
                        </div>
                        ...
                        <div class = "form-group">
                            ...
                            <div class = "col-md-4">
                                <input type = "text" class = "form-control" id = "parentid" name = "parent_id" placeholder = "Enter Parent Id">
                        ...
                        <div class = "form-group">
                            <div class = "col-md-2">
                                <label for = "">Number of accounts to register</label>
                            </div>
                            <div class = "col-md-4">
                                <select name="number_of_accounts" class="form-control">
                                    <option>1</option>
                                    <option>3</option>
                                    <option>7</option>
                                </select>
                        ...
                        <div class = "form-group">
                            ...
                            <div class = "col-md-4">
                                <input type = "text" class = "form-control" id = "Registrationpin" name = "registration_pin" placeholder = "Enter Registration Pin">
                    ...
                    <div class = "box-body">
                        ...
                        <div class = "form-group">
                            ...
                            <div class = "col-md-4">
                                <input type = "password" class = "form-control" id = "transaction_password" name = "transaction_password" placeholder = "Enter Transaction password">
                            </div>
                        </div>
                        ...
                        <div class = "form-group">
                            ...
                            <div class = "col-md-4">
                                <input type = "password" class = "form-control" id = "transactionpass2" name = "transactionPassword2" placeholder = "Conf Transaction password">
                            </div>
                        </div>
