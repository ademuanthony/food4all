    ...
    <div class="auth-container">
        <div class="card">
            ...
            <div class="auth-content">
                ...
                <p>In order to reset your password, please provide the email address you registered with.</p>
                <form id="login-form" action="<?= TinyMvc::toRoute(AppService::Login)?>" method="POST" novalidate="">
                    <div class="form-group"> <label for="login">Email Address</label> <input type="text" class="form-control underlined" name="login" id="login" placeholder="Your Email Address" required>
                    </div>
                    <div class="form-group"> <button type="submit" class="btn btn-block btn-primary">Reset Password</button> </div>
                    <div class="form-group">
                        <p class="text-muted text-xs-center">Login now? <a href="<?= TinyMvc::toRoute(AppService::Login) ?>">Take me to Login</a></p>
                    </div>
                </form>
            </div>
        </div>
