    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Manage Event Type</h5>
                <ol class="breadcrumbs">
                    ...
                    <li class="active">Manage Earning Event Type</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col s12">
            <form name="item" method="post" enctype="multipart/form-data"
                  action="<?= \Framework\TinyMvc::toRoute(\Globals\AppService::RouteBackendManageEarningEventType,
                ['id' => $eventType->getId()]) ?>">
